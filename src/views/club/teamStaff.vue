            ...
            <el-form :label-position="'right'" label-width="80px">
                <el-form :model="distributionForm" label-width="80px" ref="distributionForm">
                    ...
                    <el-form-item label="领域" prop="roleId">
                        ...
                        <el-select filterable id="" name="" placeholder="请选择角色" style="width:50%;" v-model="distributionForm.position1">
    ...
    export default {
        ...
        created: function () {
            this.areas = [
                {name:'教练组',id:1,pid:0},
                {name:'医疗队',id:2,pid:0},
                {name:'俱乐部支持',id:3,pid:0},
                {name:'球探和比赛分析员',id:4,pid:0},
                {name:'主教练',id:11,pid:1},
                {name:'助理教练',id:12,pid:1},
                {name:'守门员教练',id:13,pid:1},
                {name:'运动教练',id:14,pid:1},
                {name:'伤病预防教练',id:15,pid:1},
                {name:'健康教练',id:16,pid:1},
                {name:'康复教练',id:17,pid:1},
                {name:'技术教练',id:18,pid:1},
                {name:'心理教练',id:19,pid:1},
                {name:'随队医生',id:21,pid:2},
                {name:'理疗医师',id:22,pid:2},
                {name:'伤病预防教练',id:23,pid:2},
                {name:'体能诊断专家',id:24,pid:2},
                {name:'医师',id:25,pid:2},
                {name:'整骨医生',id:26,pid:2},
                {name:'营养师',id:27,pid:2},
                {name:'心理学家',id:28,pid:2},
                {name:'球队经理',id:31,pid:3},
                {name:'设备管理员',id:32,pid:3},
                {name:'巴士司机',id:33,pid:3},
                {name:'反兴奋剂联系人',id:34,pid:3},
                {name:'青训营主管',id:35,pid:3},
                {name:'体育总监',id:36,pid:3},
                {name:'体育经理',id:37,pid:3},
                {name:'持牌球员部门主管',id:38,pid:3},
                {name:'青训营体育总监',id:39,pid:3},
                {name:'体能训练主管',id:310,pid:3},
                {name:'青训营协调员',id:311,pid:3},
                {name:'学院主管-初级',id:312,pid:3},
                {name:'学院主管-中级',id:313,pid:3},
                {name:'青训营体育援助',id:314,pid:3},
                {name:'体育援助',id:315,pid:3},
                {name:'教学主管',id:316,pid:3},
                {name:'教学督导协助',id:317,pid:3},
                {name:'招聘主管',id:318,pid:3},
                {name:'招聘协调员',id:319,pid:3},
                {name:'管理员',id:320,pid:3},
                {name:'球员联络官',id:321,pid:3},
                {name:'管理',id:322,pid:3},
                {name:'首席球探',id:41,pid:4},
                {name:'比赛分析员',id:42,pid:4},
                {name:'球探',id:43,pid:4},
                {name:'比赛分析主管-专家',id:44,pid:4},
                {name:'比赛分析主管-学院',id:45,pid:4},
                {name:'对手分析员',id:46,pid:4}
            ];
        ...
        methods: {
            ...
            add() {
                document.getElementsByClassName("el-dialog__title")[0].innername = "添加职员";
