  ...
  <div>
    <el-card :body-style="{ padding: '0px' }" shadow="never">
      ...
      <el-table :data="pager.records" @selection-change="onSelectionChange" highlight-current-row stripe
        ...
        <el-table-column align="center" label="性别" prop="gender" width="120"></el-table-column>
        <el-table-column align="center" label="年龄" prop="ageId" width="120"></el-table-column>
        <el-table-column align="center" label="类型" prop="type" width="120"></el-table-column>
        ...
        <el-table-column align="center" label="开始时间" width="140" prop="starttime"></el-table-column>
        <el-table-column align="center" fixed="right" label="操作" width="90">
          <template slot-scope="scope">
            <el-button @click="edit(scope.$index)" size="small" type="text">编辑</el-button>
            <el-button @click="remove(scope.$index)" size="small" type="text">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!-- 赛事列表结束 -->
      ...
      <!-- 分页组件 -->
      <el-pagination :current-page="pager.current" :layout="$store.state.paginationLayout"
                     :page-size="pager.size" :page-sizes="$store.state.paginationPageSizes" :total="pager.total"
