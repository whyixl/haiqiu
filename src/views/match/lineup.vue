  ...
  <div>
    <el-card :body-style="{ padding: '0px' }" shadow="never">
      ...
      <el-table :data="pager.records" @selection-change="onSelectionChange" highlight-current-row stripe
        ...
        <el-table-column align="center" label="比赛名称" prop="name" width="180"></el-table-column>
        <el-table-column align="center" label="球队" prop="team" width="150"></el-table-column>
        <el-table-column align="center" label="阵型名" prop="lineupname" width="120"></el-table-column>
        <el-table-column align="center" label="球员" prop="playerName" width="100"></el-table-column>
      ...
      <el-form :label-position="'right'" label-width="80px">
        <el-form :model="seasonForm" :rules="seasonRule" label-width="160px" ref="seasonForm">
          <el-form-item label="比赛名称" prop="name">
            <el-select placeholder="请选择比赛名称" style="width:100%" v-model="match">
          ...
          <el-form-item label="球队">
            <el-select placeholder="请选择球队" style="width:100%" v-model="team6">
          ...
          <el-form-item label="阵型名">
            <el-select placeholder="请选择阵型名" style="width:100%" v-model="lineup">
          ...
          <el-form-item label="球员">
            <el-select placeholder="请选择球员" style="width:100%" v-model="player1">
          ...
          <el-form-item label="球员类型">
            <el-select placeholder="请选择球员类型" style="width:100%" v-model="playerType">
